...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1290: x0 => x0.toArray(),
      _1291: x0 => x0.toUint8Array(),
      _1292: x0 => ({serverTimestamps: x0}),
      _1293: x0 => ({source: x0}),
      _1296: x0 => new firebase_firestore.FieldPath(x0),
      _1297: (x0,x1) => new firebase_firestore.FieldPath(x0,x1),
      _1298: (x0,x1,x2) => new firebase_firestore.FieldPath(x0,x1,x2),
      _1299: (x0,x1,x2,x3) => new firebase_firestore.FieldPath(x0,x1,x2,x3),
      _1300: (x0,x1,x2,x3,x4) => new firebase_firestore.FieldPath(x0,x1,x2,x3,x4),
      _1301: (x0,x1,x2,x3,x4,x5) => new firebase_firestore.FieldPath(x0,x1,x2,x3,x4,x5),
      _1302: (x0,x1,x2,x3,x4,x5,x6) => new firebase_firestore.FieldPath(x0,x1,x2,x3,x4,x5,x6),
      _1303: (x0,x1,x2,x3,x4,x5,x6,x7) => new firebase_firestore.FieldPath(x0,x1,x2,x3,x4,x5,x6,x7),
      _1304: (x0,x1,x2,x3,x4,x5,x6,x7,x8) => new firebase_firestore.FieldPath(x0,x1,x2,x3,x4,x5,x6,x7,x8),
      _1305: (x0,x1,x2,x3,x4,x5,x6,x7,x8,x9) => new firebase_firestore.FieldPath(x0,x1,x2,x3,x4,x5,x6,x7,x8,x9),
      _1306: () => globalThis.firebase_firestore.documentId(),
      _1307: (x0,x1) => new firebase_firestore.GeoPoint(x0,x1),
      _1308: x0 => globalThis.firebase_firestore.vector(x0),
      _1309: x0 => globalThis.firebase_firestore.Bytes.fromUint8Array(x0),
      _1311: (x0,x1) => globalThis.firebase_firestore.collection(x0,x1),
      _1313: (x0,x1) => globalThis.firebase_firestore.doc(x0,x1),
      _1316: x0 => x0.call(),
      _1349: (x0,x1) => ({includeMetadataChanges: x0,source: x1}),
      ...
      _1352: (x0,x1,x2,x3) => globalThis.firebase_firestore.onSnapshot(x0,x1,x2,x3),
      _1353: (x0,x1,x2) => globalThis.firebase_firestore.onSnapshot(x0,x1,x2),
      _1355: (x0,x1) => globalThis.firebase_firestore.setDoc(x0,x1),
      _1356: (x0,x1) => globalThis.firebase_firestore.query(x0,x1),
      _1357: x0 => globalThis.firebase_firestore.getDocs(x0),
      _1358: x0 => globalThis.firebase_firestore.getDocsFromServer(x0),
      _1359: x0 => globalThis.firebase_firestore.getDocsFromCache(x0),
      _1360: x0 => globalThis.firebase_firestore.limit(x0),
      _1361: x0 => globalThis.firebase_firestore.limitToLast(x0),
      _1364: (x0,x1) => globalThis.firebase_firestore.orderBy(x0,x1),
      _1366: (x0,x1,x2) => globalThis.firebase_firestore.where(x0,x1,x2),
      _1369: x0 => globalThis.firebase_firestore.doc(x0),
      _1372: (x0,x1) => x0.data(x1),
      _1376: x0 => x0.docChanges(),
      _1393: (x0,x1) => globalThis.firebase_firestore.getFirestore(x0,x1),
      _1395: x0 => globalThis.firebase_firestore.Timestamp.fromMillis(x0),
      _1396: f => finalizeWrapper(f, function() { return dartInstance.exports._1396(f,arguments.length) }),
      _1414: () => globalThis.firebase_firestore.or,
      _1415: () => globalThis.firebase_firestore.and,
      _1420: x0 => x0.path,
      _1423: () => globalThis.firebase_firestore.GeoPoint,
      _1424: x0 => x0.latitude,
      _1425: x0 => x0.longitude,
      _1427: () => globalThis.firebase_firestore.VectorValue,
      _1428: () => globalThis.firebase_firestore.Bytes,
      _1431: x0 => x0.type,
      _1433: x0 => x0.doc,
      _1435: x0 => x0.oldIndex,
      _1437: x0 => x0.newIndex,
      _1439: () => globalThis.firebase_firestore.DocumentReference,
      _1443: x0 => x0.path,
      _1452: x0 => x0.metadata,
      _1453: x0 => x0.ref,
      _1458: x0 => x0.docs,
      _1460: x0 => x0.metadata,
      _1464: () => globalThis.firebase_firestore.Timestamp,
      _1465: x0 => x0.seconds,
      _1466: x0 => x0.nanoseconds,
      _1502: x0 => x0.hasPendingWrites,
      _1504: x0 => x0.fromCache,
      _1511: x0 => x0.source,
      _1516: () => globalThis.firebase_firestore.startAfter,
      _1517: () => globalThis.firebase_firestore.startAt,
      _1518: () => globalThis.firebase_firestore.endBefore,
      _1519: () => globalThis.firebase_firestore.endAt,
      _1543: (x0,x1,x2,x3,x4,x5,x6,x7) => ({apiKey: x0,authDomain: x1,databaseURL: x2,projectId: x3,storageBucket: x4,messagingSenderId: x5,measurementId: x6,appId: x7}),
      _1544: (x0,x1) => globalThis.firebase_core.initializeApp(x0,x1),
      _1545: x0 => globalThis.firebase_core.getApp(x0),
      _1546: () => globalThis.firebase_core.getApp(),
      _1548: () => globalThis.firebase_core.SDK_VERSION,
      _1554: x0 => x0.apiKey,
      _1556: x0 => x0.authDomain,
      _1558: x0 => x0.databaseURL,
      _1560: x0 => x0.projectId,
      _1562: x0 => x0.storageBucket,
      _1564: x0 => x0.messagingSenderId,
      _1566: x0 => x0.measurementId,
      _1568: x0 => x0.appId,
      _1570: x0 => x0.name,
      _1571: x0 => x0.options,
      _1572: (x0,x1) => x0.createElement(x1),
      _1573: (x0,x1) => x0.debug(x1),
      _1574: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1574(f,arguments.length,x0) }),
      _1575: f => finalizeWrapper(f, function(x0,x1) { return dartInstance.exports._1575(f,arguments.length,x0,x1) }),
      _1576: (x0,x1) => ({createScript: x0,createScriptURL: x1}),
      _1577: (x0,x1,x2) => x0.createPolicy(x1,x2),
      _1578: (x0,x1) => x0.createScriptURL(x1),
      _1579: (x0,x1,x2) => x0.createScript(x1,x2),
      ...
      _1587: () => typeof dartUseDateNowForTicks !== "undefined",
      _1588: () => 1000 * performance.now(),
      _1589: () => Date.now(),
      _1592: () => new WeakMap(),
      _1593: (map, o) => map.get(o),
      _1594: (map, o, v) => map.set(o, v),
      _1595: x0 => new WeakRef(x0),
      _1596: x0 => x0.deref(),
      _1603: () => globalThis.WeakRef,
      _1606: s => JSON.stringify(s),
      _1607: s => printToConsole(s),
      ...
      _1625: a => a.pop(),
      _1626: (a, i) => a.splice(i, 1),
      _1627: (a, s) => a.join(s),
      _1628: (a, s, e) => a.slice(s, e),
      _1631: a => a.length,
      _1633: (a, i) => a[i],
      _1634: (a, i, v) => a[i] = v,
      _1636: o => {
      ...
      _1637: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1639: o => o instanceof Uint8Array,
      _1640: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1641: o => o instanceof Int8Array,
      _1642: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1643: o => o instanceof Uint8ClampedArray,
      _1644: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1645: o => o instanceof Uint16Array,
      _1646: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1647: o => o instanceof Int16Array,
      _1648: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1649: o => o instanceof Uint32Array,
      _1650: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1651: o => o instanceof Int32Array,
      _1652: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1654: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1655: o => o instanceof Float32Array,
      _1656: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1657: o => o instanceof Float64Array,
      _1658: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1659: (t, s) => t.set(s),
      _1661: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1663: o => o.buffer,
      _1664: o => o.byteOffset,
      _1665: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1666: (b, o) => new DataView(b, o),
      _1667: (b, o, l) => new DataView(b, o, l),
      _1668: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1669: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1670: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1671: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1672: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1673: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1674: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1675: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1676: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1677: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1678: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1679: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1682: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1683: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1684: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1685: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1686: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1687: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1700: (ms, c) =>
      ...
      _1705: () => Date.now(),
      _1710: o => Object.keys(o),
      _1722: x0 => new RTCPeerConnection(x0),
      _1723: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1723(f,arguments.length,x0) }),
      _1724: (x0,x1,x2) => x0.addEventListener(x1,x2),
      ...
      _1734: (x0,x1) => x0.createOffer(x1),
      _1735: (x0,x1) => x0.createAnswer(x1),
      _1738: (x0,x1) => ({type: x0,sdp: x1}),
      _1739: (x0,x1) => x0.setLocalDescription(x1),
      _1740: (x0,x1) => ({type: x0,sdp: x1}),
      _1741: (x0,x1) => x0.setRemoteDescription(x1),
      _1742: (x0,x1,x2) => ({candidate: x0,sdpMid: x1,sdpMLineIndex: x2}),
      _1743: (x0,x1) => x0.addIceCandidate(x1),
      _1749: (x0,x1,x2,x3) => ({ordered: x0,protocol: x1,negotiated: x2,id: x3}),
      _1750: (x0,x1,x2) => x0.createDataChannel(x1,x2),
      _1760: (x0,x1) => { x0.binaryType = x1 },
      ...
      _1769: (x0,x1) => x0.send(x1),
      _1829: x0 => x0.trustedTypes,
      _1830: (x0,x1) => { x0.text = x1 },
      _1841: (s, m) => {
        try {
      ...
      _1871: o => String(o),
      _1872: (p, s, f) => p.then(s, (e) => f(e, e === undefined)),
      _1873: o => {
      ...
      _1874: o => [o],
      _1875: (o0, o1) => [o0, o1],
      _1876: (o0, o1, o2) => [o0, o1, o2],
      _1877: (o0, o1, o2, o3) => [o0, o1, o2, o3],
      ...
      _1891: x0 => x0.index,
      _1893: x0 => x0.flags,
      _1894: x0 => x0.multiline,
      _1895: x0 => x0.ignoreCase,
      _1896: x0 => x0.unicode,
      _1897: x0 => x0.dotAll,
      _1898: (x0,x1) => { x0.lastIndex = x1 },
      _1899: (o, p) => p in o,
      _1900: (o, p) => o[p],
      _1901: (o, p, v) => o[p] = v,
      _1902: (o, p) => delete o[p],
      _1903: x0 => x0.random(),
      _1906: () => globalThis.Math,
      _1907: Function.prototype.call.bind(Number.prototype.toString),
      _1908: Function.prototype.call.bind(BigInt.prototype.toString),
      _1909: Function.prototype.call.bind(Number.prototype.toString),
      _1910: (d, digits) => d.toFixed(digits),
      _3320: (x0,x1) => { x0.type = x1 },
      _3328: (x0,x1) => { x0.crossOrigin = x1 },
      _3330: (x0,x1) => { x0.text = x1 },
      _3786: () => globalThis.window,
      _3847: x0 => x0.navigator,
      _4109: x0 => x0.trustedTypes,
      _4236: x0 => x0.userAgent,
      _4286: x0 => x0.data,
      _4733: x0 => x0.signalingState,
      _4734: x0 => x0.iceGatheringState,
      _4735: x0 => x0.iceConnectionState,
      _4736: x0 => x0.connectionState,
      _4749: (x0,x1) => { x0.onicegatheringstatechange = x1 },
      _4763: x0 => x0.type,
      _4765: x0 => x0.sdp,
      _4773: x0 => x0.candidate,
      _4774: x0 => x0.sdpMid,
      _4775: x0 => x0.sdpMLineIndex,
      _4797: x0 => x0.candidate,
      _4997: (x0,x1) => { x0.onopen = x1 },
      _4999: (x0,x1) => { x0.onbufferedamountlow = x1 },
      _5005: (x0,x1) => { x0.onclose = x1 },
      _5007: (x0,x1) => { x0.onmessage = x1 },
      _5014: (x0,x1) => { x0.maxPacketLifeTime = x1 },
      _5016: (x0,x1) => { x0.maxRetransmits = x1 },
      _5026: x0 => x0.channel,
      _6439: () => globalThis.document,
      _6522: x0 => x0.head,
      _9692: x0 => x0.id,
      _13238: () => globalThis.console,
      _13266: x0 => x0.name,
      _13267: x0 => x0.message,
      _13268: x0 => x0.code,
